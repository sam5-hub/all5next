...
export async function PublishLinkDesignContent(id: string) {

}
export async function UpdateLinkDesignContent(id: string, jsonContent: string) {
  // const user = await currentUser();
  // if (!user) {
  //   throw new UserNotFoundErr();
  // }

  // return await prisma.linkProject.update({
  //   where: {
  //     userId: user.id,
  //     id,
  //   },
