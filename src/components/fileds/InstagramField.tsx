...
const type: ElementsType = "InstagramField";

const extraAttributes = {
  label: "Instagram",
  helperText: "Type Your Instagram Account here",
  required: false,
...
export const InstagramFieldFormElement: FormElement = {
  type,
  construct: (id: string) => ({
    id,
    type,
...
function FormComponent({
  ...
  return (
    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="flex flex-row gap-2">
        <InstagramIcon />
        <CopyLinkButton valueToCopy={placeHolder} href={placeHolder} />
      </div>
      {/* {helperText && <p className="text-muted-foreground text-[0.8rem]">{helperText}</p>} */}
    </div>
  );
