...
const type: ElementsType = "TwitterField";

const extraAttributes = {
  label: "Twitter",
  helperText: "Type Your Twitter Account here",
  required: false,
...
export const TwitterFieldFormElement: FormElement = {
  type,
  construct: (id: string) => ({
    id,
    type,
    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="flex flex-row gap-2">
        ...
        onBlur={(e) => {
          ...
          const valid = TwitterFieldFormElement.validate(element, e.target.value);
          setError(!valid);
          if (!valid) return;
