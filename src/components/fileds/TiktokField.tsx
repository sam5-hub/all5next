...
const type: ElementsType = "TiktokField";

const extraAttributes = {
  label: "Tiktok",
  helperText: "Type Your Tiktok Account here",
  required: false,
...
export const TiktokFieldFormElement: FormElement = {
  type,
  construct: (id: string) => ({
    id,
    type,
    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="flex flex-row gap-2">
        ...
        onBlur={(e) => {
          ...
          const valid = TiktokFieldFormElement.validate(element, e.target.value);
          setError(!valid);
          if (!valid) return;
