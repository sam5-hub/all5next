import { PublishLinkDesignContent } from "@/actions/linkDesigner";
...
function LinkPublishButton({ id }: { id: string }) {
  const [loading, startTransition] = useTransition();
  const router = useRouter();

  async function publishForm() {
    try {
      await PublishLinkDesignContent(id);
      toast({
        title: "Success",
...
export default LinkPublishButton;
